...
class BaseModel():
    ...
    def to_dict(self):
        '''
        Returns a dictionary containing all keysvalue of __dict__ of
        the instance
        '''
        dic = {}
        dic["__class__"] = self.__class__.___name__
    ...
    def to_json(self):
        '''
        returns a json containing all keysvalues of __dict__ of
        the instance
        '''
