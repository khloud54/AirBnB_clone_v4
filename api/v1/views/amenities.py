...
def list_amenities():
    '''Fetch a compilation of all Amenities entities'''
...
@app_views.('/amenities/<amenity_id>', methods=['DELETE'])
def delete_amenity(amenity_id):
    '''Deleted an Amenity object'''
    all_amenities = storage.all("Amenity").values()
    amenity_obj = [obj.to_dict() for obj in all_amenities
                   if obj.id == amenity_id]
    if amenity_obj == []:
...
@app_views.('/amenities/<amenity_id>', methods=['PUT'])
